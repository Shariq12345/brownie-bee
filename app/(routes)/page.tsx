  ...
  return (
    <div className="bg-white sm:px-2 lg:px-0 md:px-0">
      ...
      <section className="bg-gradient-to-r from-pink-50 to-pink-100">
        <Container>
          <div className="flex flex-col items-center justify-between py-12 md:py-20 lg:py-32 lg:flex-row">
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <Container>
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-8 md:mb-12 px-4">
